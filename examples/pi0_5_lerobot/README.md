...
```sh
modelscope download --model lerobot/pi05_base --local_dir /share/pi05_base
...
# The dataset should be located at: /share/lerobot/aloha_mobile_cabinet
```
...
- `model.checkpoint_dir` -> Path to pretrained model (e.g., `/share/pi05_base`)
...
- `engine.model` -> Path to pretrained model (e.g., `/share/pi05_base`)
