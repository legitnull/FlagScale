...
try:
    from . import veomni_logging as logging
    logger = logging.get_logger(__name__)
except ImportError:
    import logging
    logger = logging.getLogger(__name__)

from .veomni_device import get_device_type
...
class ParallelState:
    ...
    def dp_group(self) -> Optional["ProcessGroup"]:
        ...
        if self.sp_enabled:
            from .sequence_parallel import get_data_parallel_group
    ...
    def dp_rank(self) -> int:
        ...
        if self.sp_enabled:
            from .sequence_parallel import get_data_parallel_rank
