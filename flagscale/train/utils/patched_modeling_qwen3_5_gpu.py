...
try:
    ...
    def accepts_precomputed_kwargs(modality=None):
        """No-op decorator fallback for older transformers versions."""
        def decorator(fn):
            return fn
        return decorator
...
from .sequence_parallel import gather_outputs, slice_input_tensor, sp_pad_and_slice
from .sequence_parallel.ulysses import gather_heads_scatter_seq, gather_seq_scatter_heads
from .veomni_constants import IMAGE_INPUT_INDEX, VIDEO_INPUT_INDEX
from .veomni_device import get_device_id
from .veomni_model_outputs import CausalLMOutputWithLogProbs, FusedLinearAuxOutputMixin
